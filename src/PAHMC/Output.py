...
def Data_Output(outfilename, E, dissociation_atom, dissociation_position, dissociation_time, N_scramble_hops, N_D_hops, HH_time, HD_time, DD_time,mc):
    # Open files
    ...
    data_file.write('MC{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\n'.format(mc,dissociation_atom, dissociation_position, dissociation_time, N_scramble_hops, N_D_hops, HH_time, HD_time, DD_time))
...
def Structure_Output(outfilename, E, iteration, molecule):
    ...
    struct_file = open(fname+'_'+str(E)+'_iteration_'+str(iteration)+'_mol_structures.log', 'a')
...
def STD_Output(outfilename, dissociation_atoms, dissociation_positions, dissociation_times, N_scramble_hops, N_D_hops):
    ...
    for E in energies:
        ...
        outfile.write('H: %d, D: %d, None: %d\n' % (dissociation_atoms[E]['H'], dissociation_atoms[E]['D'], dissociation_atoms[E]['None']))
